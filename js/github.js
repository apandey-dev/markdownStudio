...
const GitHubBackend = {
    ...
    // Secure, call-stack-safe base64 encoding for huge strings (up to 100MB)
    utf8_to_b64(str) {
    ...
    // Secure memory-safe base64 decoding
    b64_to_utf8(str) {
    ...
    // Replaced standard contents API (1MB Limit) with Git Database API (100MB limit per file).
