            ...
            folders.forEach(folder => {
                ...
                if (folderNotes.length === 0) {
                    ...
                    folderNotes.forEach(note => {
                        ...
                        btnMove.onclick = (e) => { e.preventDefault(); e.stopPropagation(); window.openMoveModal(note.id); };

                        const btnRename = document.createElement('button');
                        btnRename.className = 'manager-action-btn';
                        btnRename.title = "Rename Note";
                        btnRename.innerHTML = '<i data-lucide="edit-3"></i>';
                        btnRename.onclick = (e) => { e.preventDefault(); e.stopPropagation(); window.openRenameModal(note.id); };
